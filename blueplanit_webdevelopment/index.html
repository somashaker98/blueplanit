...
<body data-spy="scroll" data-target=".fixed-top">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">Web Development</span> Make your virtual dream come true</h1>
                            <p class="p-large">We develop all types of Websites & Web based applications. We also help
                                your business by developing transformation solutions especially customized for your
                                business needs to fulfil your requirements, reduce your costs & accelerate your profits.
                            </p>
                            <a class="btn-solid-lg page-scroll" href="#services">Get a Quote</a>
                        </div> <!-- end of text-container -->
                    </div> <!-- end of col -->
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="images/header-teamwork 2.png" alt="alternative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="p-heading p-large">Our main focus, as a web and mobile app development company is to
                        provide strategic planning & industry’s best product to compete in the market.</p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="card-image" src="images/services-icon-1.png" alt="alternative">
                        <div class="card-body">
                            <h4 class="card-title">Website Development</h4>
                            <p>At BluePlanIt, we believe in providing fast, reliable and affordable services to
                                businesses of all types and sizes.
                                Relying on us for your website and application development needs will only make your
                                online journey smooth and fast.</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="card-image" src="images/services-icon-2.png" alt="alternative">
                        <div class="card-body">
                            <h4 class="card-title">Website Revamp</h4>
                            <p>Your website reflects your brand image. An outdated website which does not provide your
                                users with good user experience and engagement can hamper the business growth. You can
                                give your website a complete makeover and take it to the next level just by getting in
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="card-image" src="images/services-icon-3.png" alt="alternative">
                        <div class="card-body">
                            <h4 class="card-title">Application Development</h4>
                            <p>Your business needs more than just a website to engage your clients. We, at BluePlanIt,
                                provide our clients with top-notch application development services to companies across
                                the globe.</p>
                        </div>
                    </div>
                    <!-- end of card -->
    ...
    <div class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="images/animation_640_kiwop0g6.gif" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="text-container">
                        <h2>Design And Plan Your Business Growth Steps</h2>
                        <p>Your company's growth matters to us, as we are not here to just build you a website, but we
                            are here to build a strong brand and online presence for your business. We take care of all
                            your technology needs by providing you with a range of web application development services.
                        </p>
    ...
    <div class="basic-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h2>SEO Services for Optimal Results</h2>
                        <p>BluePlanIt provides SEO services to business at an affordable price. Our team of professional
                            marketers and SEO experts analyze your website and come up with a strategic plan to improve
                            your website ranking and performance.
                        </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <p>As a part of the web development, the services we provide include the following.</p>
                    <ul class="list-unstyled li-space-lg">
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Responsive web design</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Analytics integration</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Bespoke design</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Social media integration</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">CMS</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Technical Support</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Domain and Hosting</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Royal Free Images</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">SEO Friendly</div>
                        </li>
                    </ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <h5>Core feature</h5>
                    <p>SEO Services</p>
                    <p>As a part of the Search engine optimization, the services we provide include the following</p>
                    <ul class="list-unstyled li-space-lg">
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Website analysis</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Competitor analysis</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Keyword analysis</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Increase traffic</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Grow site conversion</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Improve website ranking</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Reputation Management</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">SEO Consultation</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body">Brand awareness</div>
                        </li>
                    </ul>
                    <a class="btn-solid-reg mfp-close page-scroll" href="#request">REQUEST</a> <a
                        class="btn-outline-reg mfp-close as-button" href="#screenshots">BACK</a>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <p>Please feel free to contact us & we would be happy to assist you!</p>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="image-container">
                        <div class="video-wrapper">
                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=fnlSM1IEDIE"
                                data-effect="fadeIn">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large"><strong>G Nagraj</strong></p>
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="images/team-member-2.jpeg" alt="alternative">
                        </div> <!-- end of image wrapper -->
                        <p class="p-large"><strong>G Soma Shaker</strong></p>
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large"><strong>Bogi Srinivas</strong></p>
                        <p class="job-title">Sr. Software Engineer</p>
                        <span class="social-icons">
                            <span class="fa-stack">
                                <a href="#your-link">
                                    <i class="fas fa-circle fa-stack-2x facebook"></i>
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large"><strong>Raju Neelakanta</strong></p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        ...
                        <li><i class="fas fa-map-marker-alt"></i>Ground Floor, Sri Ramanujan School, Railway New Colony,
                            Visakhapatnam, Andhra Pradesh, IN</li>
                        <li><i class="fas fa-phone"></i><a class="turquoise" href="tel:+91 8919947100">+91
                                8919947100</a>
                        </li>
                        <li><i class="fas fa-envelope"></i><a class="turquoise"
                                href="mailto:blueplanit.in@gmail.com">blueplanit.in@gmail.com</a></li>
                    </ul>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-6">
                    <div class="map-responsive">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3800.2211646839555!2d83.29171621537317!3d17.734215297376043!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a3943dd84184b53%3A0x1f06dbe7f274dc5b!2sBluePlanit!5e0!3m2!1sen!2sin!4v1609686176773!5m2!1sen!2sin"
                ...
                <div class="col-lg-6">
                    ...
                    <form id="contactForm" data-toggle="validator" data-focus="false">
                        ...
                        <!-- <div class="form-group checkbox">
                            ...
                            with BluePlanIt's stated <a href="privacy-policy.html">Privacy Policy</a> and <a
                                href="terms-conditions.html">Terms Conditions</a>
                            <div class="help-block with-errors"></div>
                        </div> -->
                        <div class="form-group">
                    ...
                    <div class="footer-col middle">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                ...
                                <div class="media-body">Our business partners <a class="turquoise" href="#your-link">VSA
                                        Commnets & IT Solutions</a></div>
                            </li>
                            <!-- <li class="media">
                                <i class="fas fa-square"></i>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright © 2020 - BluePlanIt - All rights reserved</p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
